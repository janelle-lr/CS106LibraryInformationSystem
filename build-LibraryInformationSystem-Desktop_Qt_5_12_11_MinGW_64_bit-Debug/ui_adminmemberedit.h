...
public:
    ...
    void setupUi(QMainWindow *adminMemberEdit)
    {
        ...
        adminMemberEdit->setMinimumSize(QSize(1280, 640));
...
"}"));
        ...
        accountIcon = new QLabel(layoutWidget_2);
        ...
        accountBtn = new QPushButton(layoutWidget_2);
...
"}"));
    ...
    void retranslateUi(QMainWindow *adminMemberEdit)
    {
        ...
        accountIcon->setText(QApplication::translate("adminMemberEdit", "account", nullptr));
        accountBtn->setText(QApplication::translate("adminMemberEdit", "Account", nullptr));
