...
""));
        ...
        pushButton->setGeometry(QRect(784, 40, 131, 23));
...
"}"));
        ...
        verticalLayout_2->addWidget(accountIcon_2);
...
"}"));
        ...
        verticalLayout_2->addWidget(accountBtn_2);
...
"}"));
    ...
    void retranslateUi(QMainWindow *adminMemberCatalogue)
    {
        ...
        memberBtn_2->setText(QApplication::translate("adminMemberCatalogue", "Member", nullptr));
        accountIcon_2->setText(QApplication::translate("adminMemberCatalogue", "account", nullptr));
        accountBtn_2->setText(QApplication::translate("adminMemberCatalogue", "Account", nullptr));
