...
public:
    ...
    void setupUi(QMainWindow *memberAccountView)
    {
        ...
        memberAccountView->resize(1280, 634);
...
"}"));
        ...
        tabWidget->setGeometry(QRect(230, 110, 1041, 461));
...
"}"));
        ...
        verticalLayout_10->addWidget(catalogueIcon_2);
...
"}"));
        ...
        verticalLayout_10->addWidget(memberIcon_2);
...
"}"));
        ...
        accountIcon_2 = new QLabel(layoutWidget);
        accountIcon_2->setObjectName(QString::fromUtf8("accountIcon_2"));
        accountIcon_2->setAlignment(Qt::AlignCenter);

        verticalLayout_10->addWidget(accountIcon_2);

        accountBtn_2 = new QPushButton(layoutWidget);
        accountBtn_2->setObjectName(QString::fromUtf8("accountBtn_2"));
        accountBtn_2->setStyleSheet(QString::fromUtf8("QPushButton{\n"
"	border-radius:15px;\n"
"	font: 14px \"Montserrat\";\n"
"}\n"
"\n"
...
"}"));
        ...
        verticalLayout_10->addWidget(accountBtn_2);
        ...
        verticalLayout_10->addWidget(signoutIcon_2);
...
"}"));
        ...
        verticalLayout_10->addWidget(signoutBtn_2);
...
"", nullptr));
        ...
        catalogueIcon_2->setText(QApplication::translate("memberAccountView", "Catalogue", nullptr));
        LoanedBooksBtn->setText(QApplication::translate("memberAccountView", "View Loaned Books", nullptr));
        memberIcon_2->setText(QApplication::translate("memberAccountView", "member", nullptr));
        reservedBooksBtn->setText(QApplication::translate("memberAccountView", "View Reserved Books", nullptr));
        accountIcon_2->setText(QApplication::translate("memberAccountView", "View Reserved Books", nullptr));
        accountBtn_2->setText(QApplication::translate("memberAccountView", "Edit Account Details", nullptr));
        signoutIcon_2->setText(QApplication::translate("memberAccountView", "signOut", nullptr));
        signoutBtn_2->setText(QApplication::translate("memberAccountView", "Sign Out", nullptr));
