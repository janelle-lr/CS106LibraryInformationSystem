...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(1052, 634);
        MainWindow->setMinimumSize(QSize(1052, 634));
        MainWindow->setMaximumSize(QSize(1052, 634));
...
"}"));
        ...
        groupBox->setGeometry(QRect(360, 200, 331, 251));
...
"}"));
        ...
        loginPushButton->setGeometry(QRect(30, 200, 271, 31));
...
"}"));
        ...
        checkBox->setGeometry(QRect(100, 120, 91, 17));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        checkBox->setText(QCoreApplication::translate("MainWindow", "Show Pass", nullptr));
