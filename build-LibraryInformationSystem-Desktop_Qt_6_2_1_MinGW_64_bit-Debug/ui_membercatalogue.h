...
"}"));
    ...
    void retranslateUi(QMainWindow *memberCatalogue)
    {
        ...
        pushButton->setText(QCoreApplication::translate("memberCatalogue", "PushButton", nullptr));
        ...
        accountBtn->setText(QCoreApplication::translate("memberCatalogue", "acount", nullptr));
