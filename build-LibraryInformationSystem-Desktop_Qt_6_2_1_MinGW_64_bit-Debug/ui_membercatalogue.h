...
public:
    ...
    void setupUi(QMainWindow *memberCatalogue)
    {
        ...
        memberCatalogue->resize(1052, 650);
...
"}"));
    ...
    void retranslateUi(QMainWindow *memberCatalogue)
    {
        ...
        actiontest->setText(QCoreApplication::translate("memberCatalogue", "test", nullptr));
        actiontest_2->setText(QCoreApplication::translate("memberCatalogue", "test 2", nullptr));
        actiontest_3->setText(QCoreApplication::translate("memberCatalogue", "test 3", nullptr));
