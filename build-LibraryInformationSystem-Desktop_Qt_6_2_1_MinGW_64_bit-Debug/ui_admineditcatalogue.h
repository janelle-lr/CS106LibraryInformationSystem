...
"}"));
    ...
    void retranslateUi(QMainWindow *adminEditCatalogue)
    {
        ...
        pushButton->setText(QCoreApplication::translate("adminEditCatalogue", "Add Book", nullptr));
...
" desription", nullptr));
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QCoreApplication::translate("adminEditCatalogue", "Book Catalogue", nullptr));
