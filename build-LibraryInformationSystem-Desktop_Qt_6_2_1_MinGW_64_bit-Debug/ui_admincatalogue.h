...
"}"));
    ...
    void retranslateUi(QMainWindow *adminCatalogue)
    {
        ...
        pushButton_2->setText(QCoreApplication::translate("adminCatalogue", "delete record", nullptr));
        pushButton->setText(QCoreApplication::translate("adminCatalogue", "print all records", nullptr));
    } // retranslateUi
