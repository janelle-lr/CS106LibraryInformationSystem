...
"}"));
    ...
    void retranslateUi(QMainWindow *memberAccountView)
    {
        ...
        editAccountIcon->setText(QApplication::translate("memberAccountView", "back to catalogue", nullptr));
        editAccountBtn->setText(QApplication::translate("memberAccountView", "Edit Account", nullptr));
        bcktoCatologueIcon->setText(QApplication::translate("memberAccountView", "back to catalogue", nullptr));
        bcktoCatologueBtn->setText(QApplication::translate("memberAccountView", "Back to Catologue", nullptr));
        ...
        pageDesc->setText(QApplication::translate("memberAccountView", "Hey user, change your stuff here. If you don't like it then yikes \n"
