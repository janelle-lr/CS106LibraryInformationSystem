...
"}"));
        ...
        description->setGeometry(QRect(30, 480, 941, 71));
...
"}"));
    ...
    void retranslateUi(QMainWindow *BookDetails)
    {
        ...
        backIcon->setText(QApplication::translate("BookDetails", "go back", nullptr));
        backBtn->setText(QApplication::translate("BookDetails", "Go Back", nullptr));
