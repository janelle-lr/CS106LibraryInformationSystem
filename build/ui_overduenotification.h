...
"}"));
    ...
    {
        OverdueNotification->setWindowTitle(QApplication::translate("OverdueNotification", "Dialog", nullptr));
        pageTitle->setText(QApplication::translate("OverdueNotification", "Hey! You have overdue books!", nullptr));
        pageDesc->setText(QApplication::translate("OverdueNotification", "Here's a list of overdue books you have:", nullptr));
    } // retranslateUi
