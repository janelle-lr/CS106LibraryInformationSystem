...
"}"));
    ...
    {
        memberAccountViewV2->setWindowTitle(QCoreApplication::translate("memberAccountViewV2", "Dialog", nullptr));
        logoImage->setText(QString());
        viewCatalogue->setText(QCoreApplication::translate("memberAccountViewV2", "CATALOGUE", nullptr));
        viewAccount->setText(QCoreApplication::translate("memberAccountViewV2", "ACCOUNT", nullptr));
        viewCatalogue_2->setText(QCoreApplication::translate("memberAccountViewV2", "LOG OUT", nullptr));
    } // retranslateUi
