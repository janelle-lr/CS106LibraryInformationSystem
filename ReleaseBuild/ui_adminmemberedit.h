...
"}"));
        ...
        label_6->setGeometry(QRect(320, 30, 231, 81));
...
""));
        ...
        updateMemberButton->setStyleSheet(QString::fromUtf8("QPushButton {\n"
...
"}"));
    ...
    void retranslateUi(QMainWindow *adminMemberEdit)
    {
        ...
        label_6->setText(QCoreApplication::translate("adminMemberEdit", "Edit Member Details", nullptr));
        memberIcon->setText(QCoreApplication::translate("adminMemberEdit", "back", nullptr));
        memberBtn->setText(QCoreApplication::translate("adminMemberEdit", "Go Back", nullptr));
