...
"}"));
    ...
    void retranslateUi(QMainWindow *adminEditBook)
    {
        ...
        pageDesc->setText(QCoreApplication::translate("adminEditBook", "Make any corrections or changes to the book you selected. Press save once you're done!", nullptr));
