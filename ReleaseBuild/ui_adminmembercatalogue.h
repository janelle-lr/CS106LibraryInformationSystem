...
"}"));
    ...
    void retranslateUi(QMainWindow *adminMemberCatalogue)
    {
        ...
        memberBtn_2->setText(QCoreApplication::translate("adminMemberCatalogue", "Members", nullptr));
        ...
        pageDesc->setText(QCoreApplication::translate("adminMemberCatalogue", "Here are all the existing members that have signed up with us! You can view, edit, or even delete them.", nullptr));
