...
"}"));
    ...
    {
        LoanedBookNotification->setWindowTitle(QCoreApplication::translate("LoanedBookNotification", "Dialog", nullptr));
        pageTitle->setText(QCoreApplication::translate("LoanedBookNotification", "Book has been loaned!", nullptr));
        pageDesc->setText(QCoreApplication::translate("LoanedBookNotification", "Congrats! This book is now in your account. Check your account to see!", nullptr));
    } // retranslateUi
