...
"}"));
    ...
    {
        ReturnBooksNotification->setWindowTitle(QCoreApplication::translate("ReturnBooksNotification", "Dialog", nullptr));
        pageDesc->setText(QCoreApplication::translate("ReturnBooksNotification", "I hope You had a good time reading! These books have been automatically removed from your account.", nullptr));
        pageTitle->setText(QCoreApplication::translate("ReturnBooksNotification", "Thanks for returning our books!", nullptr));
    } // retranslateUi
