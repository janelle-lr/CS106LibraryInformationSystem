...
"}"));
        ...
        verticalLayout_11->addWidget(bcktoCatologueIcon);
...
"}"));
        ...
        verticalLayout_11->addWidget(bcktoCatologueBtn);
...
"}"));
    ...
    {
        memberViewReserves->setWindowTitle(QCoreApplication::translate("memberViewReserves", "MainWindow", nullptr));
        pageTitle->setText(QCoreApplication::translate("memberViewReserves", "Reserved Books", nullptr));
        loanedBooksIcon->setText(QCoreApplication::translate("memberViewReserves", "Catalogue", nullptr));
        loanedBooksBtn->setText(QCoreApplication::translate("memberViewReserves", "Loaned Books", nullptr));
        reservedBooksIcon->setText(QCoreApplication::translate("memberViewReserves", "member", nullptr));
        reservedBooksBtn->setText(QCoreApplication::translate("memberViewReserves", "Reserved Books", nullptr));
        editAccountIcon->setText(QCoreApplication::translate("memberViewReserves", "Reserved Books", nullptr));
        editAccountBtn->setText(QCoreApplication::translate("memberViewReserves", "Account Details", nullptr));
        bcktoCatologueIcon->setText(QCoreApplication::translate("memberViewReserves", "back to catalogue", nullptr));
        bcktoCatologueBtn->setText(QCoreApplication::translate("memberViewReserves", "Back to Catologue", nullptr));
        signoutIcon->setText(QCoreApplication::translate("memberViewReserves", "signOut", nullptr));
        signoutBtn->setText(QCoreApplication::translate("memberViewReserves", "Sign Out", nullptr));
        pageDesc->setText(QCoreApplication::translate("memberViewReserves", "Here are the books reserved under your account! These books will automatically be put in your account when they become available!", nullptr));
